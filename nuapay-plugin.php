...
define('NUAPAY_PLUGIN_VER', '1.0.3');
...
require_once(NUAPAY_PLUGIN_DIR . 'shortcode/shortcode.php');
...
function np_options_validate($input) {
	...
	$input[NPSettings::API_URL] =  wp_filter_nohtml_kses($input[NPSettings::API_URL]);
